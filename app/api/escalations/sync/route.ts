...
import { getEscalationQueueOverview, syncEscalationQueue } from "@/lib/escalations";
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    return serverError(error, "Failed to sync escalation queue.", "ESCALATION_SYNC_FAILED");
  }
}
